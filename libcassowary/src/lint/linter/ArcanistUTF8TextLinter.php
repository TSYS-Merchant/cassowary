...
/**
 * Enforces Basic and UTF8 text file rules.
 */
final class ArcanistUTF8TextLinter extends ArcanistLinter {
    ...
    public function getInfoName() {
        return pht('Basic Text Linter with UTF8 Support');
    }
    ...
    public function setAllowUTF8($is_allow_utf8) {
        $this->allowUTF8 = $is_allow_utf8;
        return $this;
    }
